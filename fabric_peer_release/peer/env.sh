...
export set CORE_PEER_ADDRESS=10.1.24.241:7051
export set CORE_PEER_GOSSIP_EXTERNALENDPOINT=10.1.24.241:7051
...
export set CORE_PEER_FILESYSTEMPATH=/home/fabric_peer_release/production
